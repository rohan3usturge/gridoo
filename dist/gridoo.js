        ...
        this.setFocusToLastElement = function () {
            ...
            if (element) {
                ...
                if (element.tagName.toLowerCase() === "th") {
                    ...
                    var dataHeaderValue_1 = element.getAttribute("data-header-value");
                    var newFocusable_1;
                    $(".filter-label").each(function (index, elem) {
                        var eachHeader = $(elem);
                        var eachHeaderId = eachHeader.attr("data-attr-id");
                        var eachHeaderValue = eachHeader.attr("data-attr-value");
                        if (eachHeaderId === dataHeaderId_1 && eachHeaderValue === dataHeaderValue_1) {
