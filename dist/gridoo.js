...
var Grid = /** @class */ (function () {
    function Grid(options) {
        ...
        this.bindManageColums = function (manageColContainer) {
            ...
            var toggleHandler = new ToggleColumnHandler_1.ToggleColumnHandler(_this.configStore, jQuery(_this.configStore.Options.containerElement));
            var manageColHandler = new ColSettingsHandler_1.ColSettingsHandler(jQuery(element), _this.configStore, toggleHandler);
